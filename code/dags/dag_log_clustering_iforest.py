...
def train_isolation_forest():
    with tracer.start_as_current_span("train_isolation_forest") as span:
        span.set_attribute("function", "train_isolation_forest")
        logger.info("Started training rca model using isolation forest")
        s3 = boto3.client("s3")
        logger.info("Started training rca model using clustering based on isolation forest")
        ...
        logger.info(f"✅ Best IsolationForest model uploaded. Best score: {study.best_value:.4f}, Params: {best_params}")
